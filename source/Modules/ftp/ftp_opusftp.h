...
#define CONNECT_TEMPLATE \
	"HOST,PORT/N/K,USER,PASSWORD=PASS,DIR/K,LISTER/K,SITE/K,GUI/S,NOSCAN/S,RECON/S,TLS/K,TLSVERIFY=VERIFY/S,NOVERIFY/S,PROTOCOL=PROTO/K"
...
enum {
	...
	MID_CONNECT,	  // HOST,PORT,USER,PASS,DIR/K,LISTER/K
